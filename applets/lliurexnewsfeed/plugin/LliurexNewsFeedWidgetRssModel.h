#ifndef PLASMA_LLIUREX_NEWS_FEED_WIGET_RSS_MODEL_H
#define PLASMA_LLIUREX_NEWS_FEED_WIGET_RSS_MODEL_H
 ...
 */
class LliurexNewsFeedWidgetRssModel : public QAbstractListModel
{
    Q_OBJECT
...
public: // additional helper functions
     ...
     */
    void updateItems(const QVector<LliurexNewsFeedWidgetRssItem> &items);
...
#endif // PLASMA_LLIUREX_NEWS_FEED_WIGET_RSS_MODEL_H
